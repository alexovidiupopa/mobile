package ro.alexpopa.documents.adapter;
...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.ViewHolder> {
    ...
    public void setItems(List<Document> books) {
        this.items = books;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.mContentView.setText(items.get(position).getName() + " " + items.get(position).getSize() + " " + items.get(position).getUsage() + " " + items.get(position).getOwner());
