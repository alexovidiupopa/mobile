...
public class AddActivity extends AppCompatActivity implements MyCallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(i->{
            ...
            manager.save(progressBar,new Order(0, textView2.getText().toString(), textView3.getText().toString(),Integer.parseInt(user),Integer.parseInt(textView4.getText().toString()),textView5.getText().toString()), this);
            finish();
        });
